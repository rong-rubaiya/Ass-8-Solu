...
const Nav = () => {
  ...
  <div className="navbar-end">
    <Link to={'https://github.com/rong-rubaiya'}><button  className="btn text-base bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white"> <FaGithub />Contribute</button></Link>
  </div>
</div>
  );
};
